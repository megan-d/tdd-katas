...
def test_year_divisible_by_400_returns_true():
    assert is_leap(2000) is True
    assert is_leap(1200) is True


def test_year_not_divisble_by_400_returns_false():
    assert is_leap(2021) is False
    assert is_leap(500) is False


def test_year_divisible_by_100_but_not_400_returns_false():
...
def test_year_divisible_by_100_and_400_returns_true():
    assert is_leap(2000) is True
    assert is_leap(1200) is True


def test_year_divisible_by_4_but_not_100_returns_true():
    assert is_leap(2008) is True
    assert is_leap(2012) is True
    assert is_leap(2016) is True


def test_year_not_divisible_by_4_returns_false():
